...
CREATE TABLE `T_ARGUMENT` (
  ...
  `argument_content` longtext COLLATE utf8_unicode_ci COMMENT '论据内容',
...
INSERT INTO `T_ARGUMENT` VALUES (39,'我是正方',0,1,'2016-04-16 14:18:11',1,1,1,10),(40,'我是正方222',1,1,'2016-04-16 14:45:45',1,1,1,10),(41,'我是反方',1,0,'2016-04-16 14:46:11',1,1,1,9),(42,'Adasd',0,1,'2016-05-07 08:45:57',1,1,1,9);
...
CREATE TABLE `T_BOOKPOST` (
  ...
  `bookpost_title` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '帖子标题',
  `bookpost_content` longtext COLLATE utf8_unicode_ci COMMENT '帖子内容',
  `bookpost_book_name` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '帖子关联图书',
...
CREATE TABLE `T_BOOKPOST_COMMENT_REPLY` (
  ...
  `reply_content` longtext COLLATE utf8_unicode_ci COMMENT '回复内容',
...
INSERT INTO `T_BOOKPOST_COMMENT_SUP_RECORD` VALUES (1,'2016-04-15 21:38:11',1,3,1),(2,'2016-04-16 13:40:09',0,4,1),(3,'2016-04-16 14:42:04',1,7,1),(4,'2016-05-07 08:44:40',1,1,1);
...
INSERT INTO `T_BOOKPOST_SUP_RECORD` VALUES (1,'2016-04-16 14:13:28',1,1,1),(2,'2016-04-16 14:17:18',1,15,1),(3,'2016-04-16 14:41:40',1,16,1),(4,'2016-05-03 19:13:24',0,4,1),(5,'2016-05-07 08:44:30',1,3,1);
...
CREATE TABLE `T_COUPLET` (
  ...
  `couplet_content` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '对联内容',
...
INSERT INTO `T_COUPLET_REPLY` VALUES (1,'啊啊啊',0,'2016-04-15 21:59:49',1,26,1),(2,'aaaaa',1,'2016-04-16 14:15:35',1,26,1),(3,'呵呵呵',0,'2016-04-16 14:45:00',1,28,1),(4,'Assad',0,'2016-05-07 08:45:37',1,28,1);
...
INSERT INTO `T_COUPLET_REPLY_SUP_RECORD` VALUES (1,'2016-04-16 14:15:59',1,2,1),(2,'2016-04-16 14:45:07',0,3,1);
...
CREATE TABLE `T_FIELD` (
  ...
  `field_name` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '领域名称',
...
CREATE TABLE `T_LEVELS` (
  ...
  `level_name` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '等级称谓',
...
CREATE TABLE `T_QUESTION` (
  ...
  `question_content` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '题目内容',
  `question_option_one` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '选项一',
  `question_option_two` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '选项二',
  `question_option_three` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '选项三',
  `question_answer` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '正确答案',
  `question_collect_number` int(11) NOT NULL DEFAULT '0' COMMENT '收藏题目人数',
  `question_show_order` varchar(4) CHARACTER SET utf8 NOT NULL DEFAULT '1234' COMMENT '选项展示顺序',
...
CREATE TABLE `T_STATE` (
  ...
  `state_name` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '状态名称',
  `state_value` int(11) NOT NULL COMMENT '状态值',
  `state_type` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '状态类型(标识所属哪个表)',
...
CREATE TABLE `T_THESIS` (
  ...
  `thesis_content` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '辩题内容',
  `thesis_pros` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '正方论点',
  ...
  `thesis_cons` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '反方论点',
  ...
  `thesis_add_reson` longtext COLLATE utf8_unicode_ci COMMENT '添加辩题原因',
...
CREATE TABLE `T_USER` (
  ...
  `user_account` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '用户账号',
  `user_password` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '用户密码',
  `user_name` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT '用户昵称',
...
INSERT INTO `T_USER` VALUES (1,'18850459303','96e79218965eb72c92a549dd5a330112','飞花蝶舞剑2',11,'201605070848455464.jpeg',2,739,'2015-10-01 11:00:00',1),(2,'18850459302','e10adc3949ba59abbe56e057f20f883e','赫夫曼不会浪漫',18,'zcp',15,125,'2015-10-01 16:00:00',1),(3,'18850459330','e10adc3949ba59abbe56e057f20f883e','小吴1258',12,'zcp',19,225,'2015-10-02 17:00:00',1),(4,'18850459304','e10adc3949ba59abbe56e057f20f883e','小龙虾',20,'zcp',15,1050,'2015-10-03 13:00:00',1),(5,'18850459305','e10adc3949ba59abbe56e057f20f883e','Oo冰河葬寒心oO',40,'zcp',14,3200,'2015-10-03 14:00:00',1),(6,'18850459306','e10adc3949ba59abbe56e057f20f883e','kylin',22,'zcp',20,12000,'2015-10-03 15:00:00',1),(7,'18850459307','e10adc3949ba59abbe56e057f20f883e','尤少楼',21,'zcp',20,12253,'2015-10-04 11:00:00',1),(8,'18850459308','e10adc3949ba59abbe56e057f20f883e','骑着麦兜谈恋爱',20,'zcp',14,22332,'2015-10-05 11:00:00',1),(9,'18850459309','e10adc3949ba59abbe56e057f20f883e','天懒少华',20,'zcp',29,6050,'2015-10-06 11:00:00',1),(10,'18850459310','e10adc3949ba59abbe56e057f20f883e','坑娃的爹',22,'zcp',11,3000,'2015-10-10 21:06:00',1),(11,'18850459301','670b14728ad9902aecba32e22fa4f6bd','名字',0,'default.png',0,0,'2016-04-16 14:58:52',1);
...
INSERT INTO `T_USER_COLLECT_BOOKPOST` VALUES (1,'2016-04-16 14:13:22',1,1,1),(2,'2016-04-16 14:17:19',1,1,15),(3,'2016-04-16 14:41:39',1,1,16),(4,'2016-05-03 19:13:22',0,1,4),(5,'2016-05-07 08:44:28',1,1,3);
...
INSERT INTO `T_USER_COLLECT_THESIS` VALUES (1,'2016-04-16 14:07:40',0,1,1);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proc_QuestionReplaceNew_Update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_QuestionReplaceNew_Update`(IN `pageCount` INT)
    NO SQL
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proc_ThesisReplaceNew_Update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_ThesisReplaceNew_Update`()
    NO SQL
BEGIN
...
-- Dump completed on 2016-06-01  9:09:19
