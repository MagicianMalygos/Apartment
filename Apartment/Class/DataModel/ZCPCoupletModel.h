...
@property (nonatomic, assign) int coupletId;                        // 对联表编号
@property (nonatomic, copy) NSString *coupletContent;               // 对联内容
@property (nonatomic, assign) int coupletReplyNumber;               // 回复人数
@property (nonatomic, assign) int coupletCollectNumber;             // 收藏对联人数
@property (nonatomic, assign) int coupletSupport;                   // 点赞量
